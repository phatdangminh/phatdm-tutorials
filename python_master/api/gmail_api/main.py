...
receiver = "Mail Trap <1f9157574b-6ac242@inbox.mailtrap.io>"
...
============= Demo Header, Footer Mail Template

%s
%s

""" % (receiver, sender, html_header_doc.encode('utf-8'), html_footer_doc.encode('utf-8'))
